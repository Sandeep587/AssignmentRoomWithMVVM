package com.mintu.assignment5paisa.adapters.watchlistthree
...
class WatchListThreeAdapter(
    private val itemList: List<WatchListThreeData>,
    private val isGrid: String,
    val listener: (WatchListThreeData) -> Unit
) :
    RecyclerView.Adapter<WatchListThreeAdapter.ViewHolder>() {
