package com.mintu.assignment5paisa.adapters.watchlisttwo
...
class WatchListTwoAdapter(
    private val itemList: List<WatchListTwoData>,
    private val isGrid: String,
    val listener: (WatchListTwoData) -> Unit
) :
    RecyclerView.Adapter<WatchListTwoAdapter.ViewHolder>() {
